...
app.get('/app/virtualcard/get/akun', [
	...
	let sqlsyn = `
	SELECT kode_akun, role, kode_kelas, nama, CONCAT('https://preview-gtc.ieu.link?id=',TO_BASE64(TO_BASE64(kode_akun))) AS qrcode FROM tb_akun WHERE role='guru' ORDER BY kode_kelas ASC;
	`;
